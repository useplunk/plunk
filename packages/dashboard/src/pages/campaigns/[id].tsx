...
export default function Index() {
  ...
  const send = async (data: CampaignValues) => {
    ...
    toast.success("Starting delivery now, please hold on!");
    ...
    toast.promise(
...

      {
        ...
        success: () => {
          ...
          return `Started delivery of your campaign to ${
                ...
                campaign.status !== "DELIVERED" && (
                  ...
                  >
                    <Alert type={"info"} title={"Automatic batching"}>
                      Your campaign will be sent out in batches of{" "}
                      {RATE_LIMIT || 400} recipients each. It will be delivered
                      to all contacts{" "}
                      {dayjs().to(
                        dayjs().add(
