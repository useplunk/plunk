...
import {PageUiButton} from './button';
import {cn} from './cn';
...
const CarouselPrevious = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<typeof PageUiButton>
>(({className, variant = 'outline', size = 'icon', ...props}, ref) => {
  ...
  return (
    <PageUiButton
      ...
      size={size}
      className={cn(
        'absolute h-8 w-8 rounded-full disabled:opacity-100 disabled:text-gray-400 dark:disabled:text-gray-800',
